...
public class TaskDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportView(jTextNotes);
...
public static void main(String args[]) {
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ...
        try {
            ...
            task.setDescription(jTextDescription.getText());
            SimpleDateFormat data = new SimpleDateFormat("dd/MM/yyyy");
            task.setNotes(jTextNotes.getText());
            Date completed;
            completed = data.parse(jFormattedTextField1.getText());
