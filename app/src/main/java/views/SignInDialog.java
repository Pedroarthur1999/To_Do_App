...
public class SignInDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jButtonCadastro.setBackground(new java.awt.Color(51, 0, 255));
        ...
        jButtonCadastro.setText("SIGN IN");
        jButtonCadastro.setToolTipText("");
        ...
        jLabelBack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/seta-esquerda (2).png"))); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cadastro.png"))); // NOI18N
    ...
    private void jButtonCadastroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonCadastroMouseClicked
        ...
        char[] passwordChar, confirmChar;
        passwordChar = jPasswordField1.getPassword();
        confirmChar = jPasswordField2.getPassword();
        String password = new String(passwordChar);

        user.setLogin(jTextFieldEmail.getText());
        ...
        if (Arrays.equals(passwordChar, confirmChar)) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Senhas incorretas, tente novamente!");
    ...
    public void setController(UserControls controller) {
